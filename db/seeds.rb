...
template1 = Atemplate.create(title: "{{UCSD soph}} will be in {{NYC next week}} -- coffee?", 
...
template2 = Atemplate.create(title: "{{Introducing Ning to Blue Shirt Capital}} {{A USEFUL SUBJECT LINE!}}", 
...
template3 = Atemplate.create(title: "{{[Inquiry] Background in dispatch systems with Pinpoint}}", 
...
template4 = Atemplate.create(title: "Updates on {{Company Name}}", 
...
template5 = Atemplate.create(title: "Here's the info you requested about {{product_name}}...", 
...
template6 = Atemplate.create(title: "Congrats on the {{product release/great quarter/NYT coverage/financing/new customer}} {{THE MORE SPECIFIC THE BETTER}}", 
...
template7 = Atemplate.create(title: "{{A Business Week article for you}}" , 
...
template8 = Atemplate.create(title: "{{Addressing your comments on pricing}}", 
...
template9 = Atemplate.create(title: "Project Inquiry", 
